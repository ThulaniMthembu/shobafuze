document.addEventListener('DOMContentLoaded', function () {
	...
	const submissionModalClose = document.getElementById(
	...
	function toggleMenu() {
		...
		hamburger.innerHTML =
			hamburger.innerHTML === hamburgerIcon ? closeIcon : hamburgerIcon;
	}
		...
		try {
			...
			if (response.ok) {
				submissionMessage.innerHTML =
					'Submitted successfully! <br> Thank you for your submission! We will get back to you as soon as possible.';
				showModal(submissionModal);
				form.reset();
			} else {
				const responseData = await response.json();
				if (responseData.errors) {
					submissionMessage.innerHTML = responseData.errors
